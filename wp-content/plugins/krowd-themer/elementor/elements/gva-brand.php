...
class GVAElement_Brand extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Brand', 'krowd-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => [
                    'url' => GAVIAS_KROWD_PLUGIN_URL . 'elementor/assets/images/brand.png',
                ],
                'dynamic' => [
                  'active' => true,
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => array(
                    array(
                        'title'  => esc_html__( 'Brand 1', 'krowd-themer' )
                    ),
                    array(
                        'title'  => esc_html__( 'Brand 2', 'krowd-themer' )
                    ),
                    array(
                        'title'  => esc_html__( 'Brand 3', 'krowd-themer' )
                    ),
                    array(
                        'title'  => esc_html__( 'Brand 4', 'krowd-themer' )
                    ),
                    array(
                        'title'  => esc_html__( 'Brand 5', 'krowd-themer' )
                    ),
                    array(
                        'title'  => esc_html__( 'Brand 6', 'krowd-themer' )
                    ),
                ),
            ]
        );
        $this->add_control(
            ...
            array(
                ...
                'default' => 'style-1',
                'options' => [
                  'style-1' => esc_html__('Carousel 2 Rows', 'krowd-themer'),
                  'style-2' => esc_html__('Carousel 1 Row', 'krowd-themer'),
                ]
            )
        );
