...
class GVAElement_Career_Block extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Career Block', 'krowd-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					'url' => GAVIAS_KROWD_PLUGIN_URL . 'elementor/assets/images/icon.png',
				],
			]
		);
		...
		$this->add_control(
			'job_type',
			[
				'label' => __( 'Job Type', 'krowd-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'Full Time'
			]
		);
		...
		$this->start_controls_section(
			'info_type_style',
			[
				'label' => __( 'Information (Address & Company)', 'krowd-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
