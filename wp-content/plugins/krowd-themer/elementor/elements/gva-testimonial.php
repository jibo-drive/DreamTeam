...
class GVAElement_Testimonial extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Testimonials', 'krowd-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => [
                  ...
                  'style-2' => esc_html__('Style II - Carousel Single', 'krowd-themer'),
                ]
            )
         );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => array(
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'krowd-themer' ),
                        'testimonial_name'     => esc_html__( 'Christine Eve', 'krowd-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'krowd-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_KROWD_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ),
                    array(
                        ...
                        'testimonial_job'      => esc_html__( 'Customer', 'krowd-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_KROWD_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ),
                    ...
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'krowd-themer' ),
                        'testimonial_name'     => esc_html__( 'David Anderson', 'krowd-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'krowd-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_KROWD_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ...
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'krowd-themer' ),
                        'testimonial_name'     => esc_html__( 'Susan Neill', 'krowd-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'krowd-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_KROWD_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
