...
class GVAElement_Video_Carousel extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Video Carousel', 'krowd-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
           'video_link',
            [
                ...
                'type'    => Controls_Manager::TEXT,
                'description' => esc_html__( 'You can add youtube/vimeo video link', 'krowd-themer' )
            ]
        );
        ...
        $this->add_control(
            'videos_content',
            [
                'label'       => __('Video Content', 'krowd-themer'),
