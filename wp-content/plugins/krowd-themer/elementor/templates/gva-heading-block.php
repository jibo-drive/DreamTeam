<?php
   ...
   if($settings['icon'] == 'yes'){
      ...
      if(empty($icon_image)) $icon_image = GAVIAS_KROWD_PLUGIN_URL . 'elementor/assets/images/icon-heading.png';
   }
   ...
   $this->add_render_attribute( 'sub_title', 'class', ['sub-title', $settings['sub_title_highlight'] == 'yes' ? 'highlight-dot' : '' ] );
