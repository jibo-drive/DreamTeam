 ...
 * 
 */
  $columns_lg = krowd_get_option('blog_columns_lg', '2');
  $columns_md = krowd_get_option('blog_columns_md', '2');
  $columns_sm = krowd_get_option('blog_columns_sm', '1');
  $columns_xs = krowd_get_option('blog_columns_xs', '1');

?>

<div class="clearfix">

    <?php do_action( 'krowd_page_content_before' ); ?>
    ...
    <?php do_action( 'krowd_page_content_after' ); ?>
