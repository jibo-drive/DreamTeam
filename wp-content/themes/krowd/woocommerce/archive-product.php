...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
  ...
  $sidebar_layout_config = krowd_get_option('woo_sidebar_config', '');
  $left_sidebar = krowd_get_option('woo_left_sidebar', '');
  $right_sidebar = krowd_get_option('woo_right_sidebar', '');
         ...
         <div class="content-page <?php echo esc_attr($main_content_config['class']); ?>">      
                  ...
                  <div class="shop-loop-container">
                    <div class="gvawooaf-before-products layout-grid">
                      ...
                      <?php do_action('krowd_woocommerce_active_filter' );  ?>
