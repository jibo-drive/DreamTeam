...
require_once(KROWD_THEME_DIR . '/includes/sample/init.php');
...
function krowd_init_scripts(){
  ...
  wp_enqueue_style('bootstrap', KROWD_THEME_URL . '/css/' . $skin . 'bootstrap.css', array(), '1.0.3' , 'all'); 
  wp_enqueue_style('krowd-woocoomerce', KROWD_THEME_URL . '/css/' . $skin . 'woocommerce.css', array(), '1.0.3' , 'all'); 
  wp_enqueue_style('krowd-template', KROWD_THEME_URL . '/css/' . $skin . 'template.css', array(), '1.0.3' , 'all');
}
